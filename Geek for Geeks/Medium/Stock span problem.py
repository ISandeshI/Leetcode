# Stock span problem
# stack included
# Difficulty: MediumAccuracy: 43.56%Submissions: 264K+Points: 4
...
class Solution:
    def calculateSpan(self, arr):
        ...
        for i in range(n):
            while indexStack and arr[indexStack[-1]] <= arr[i]:
                indexStack.pop()

            if not indexStack:
                ans.append(i + 1)
            else:
                ans.append(i - indexStack[-1])
...
"""
This is similar to Leetcode 901. Online Stock Span
Thanks to shash code for detailed algorithmic approach for this problem.
