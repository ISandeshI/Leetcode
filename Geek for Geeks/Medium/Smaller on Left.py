# Smaller on Left
# stack included
# Difficulty: MediumAccuracy: 54.85%Submissions: 79K+Points: 4Average Time: 15m
...
"""
Used same logic but in opposite direction from monotonic stack question of NGE(Next Greater Element).
"""